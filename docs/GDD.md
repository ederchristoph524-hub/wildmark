...
### Soziales
- Dörfer mit NPCs, Händlern und Quests; Ruf auf beiden Pfaden (umgesetzt: `Renown` mit Ansehen und Berüchtigtheit, Wanderer, Kopfgeldjäger, Aufschläge und Beitrittsbedingungen je Fraktion).
...
Dezente Ambient-Musik pro Region, klare Soundeffekte für Gu-Fähigkeiten (jeder Pfad mit eigenem Klangcharakter), deutliche Warnsounds für Telegraphen und Killer-Move-Kanalisierung von Gegnern. Umgesetzt: alle Klänge werden zur Laufzeit erzeugt (`SoundSynth`, keine Audiodateien) – Gu-Wirken mit eigener Klangfarbe je Pfad (Knistern für Feuer, Surren für Blitz, Glocken für Eis, Licht, Stern und Klang …), Treffer, Beute, Stufen-Glocke, Durchbruch-Gong, Killer-Move-Donner, Trommel beim Duell, Wind als Ambiente, nachts Grillen und ein Summen beim Kultivieren; Lautstärke im Pausenmenü (`Sound`). Dazu leise, erzeugte Musik: gezupfte Saiten (Karplus-Strong) auf pentatonischen Tonleitern je Region, nachts tiefer und seltener.
...
**Aktueller Stand (sterbliche Ebene Rang 1–5 inhaltlich angelegt, noch ohne Playtest):** Neues Spiel mit spielbarer oder übersprungener Kindheit (Dorfältester, Onkel und Tante wie bei Fang Yuan, Beeren fürs Fest, Erwachen), Talent (inkl. der Zehn Extremen Physiques) und Todesmodus; Kultivieren mit Aura, Stufen und Durchbruch bis Rang 5; **dreizehn bereisbare Gebiete** in fünf Regionen (jede mit mindestens zwei): Qing-Mao-Berg (Rang 1–2, Gu-Yue-, Bai- und Xiong-Dorf, Blumenwein-Erbe), Drei-Könige-Erbe (Rang 2–3, drei Erbschaften), Shang-Klan-Stadt (Rang 3, Handelsstadt mit Markt, Arena, Pagode, Auktionator), Graslande der Nördlichen Ebene (Rang 3–4, Jurtenlager, Wolfsflut-Hort), Oasenstadt im Sandmeer (Rang 4, Lehmstadt am Teich, Tempel unter den Dünen), Roter Drachenfluss (Rang 4–5, Wu-Festung, Drachenhort, der rote Fluss selbst mit Tal und Holzbrücke), Zehntausend Inseln (Rang 5, Meer mit Inseldörfern, Grotte des Seekönigs) Berg der großen Sekten (Rang 5, Sekte der Zehn Extreme mit Terrassen, Versteck der Schattensekte), Blutsümpfe (Rang 3–4, Versteck von Fang Yuans Blutflügel-Sekte, Wu-Späherlager, Grotte des Blutmeer-Ahnen mit Blutpuppe) Yi-Tian-Berg (Rang 4–5, Bergsekte im Schnee, Lager des Ge-Stammes, Schrein des Riesensonnen-Ehrwürdigen) Flammenwut-Schlucht (Rang 3–4, rote Schluchten, Dorf des Federvolks, Erbe des Paradies-Erdwalls), Nebelriff (Rang 4–5, Leuchtturminsel der Ostmeer-Allianz, Seeräubernest, Tempel unter den Wellen) und Tal der Himmelskraniche (Rang 5, große Sekte des Zentralkontinents, nur für Geachtete, Grab des Kranich-Unsterblichen mit Sturmkranich-Geist); dazu das Huang-Jin-Lager in den Graslanden. Erben mit eigener Bauform (Höhle, Grabhügel, Tempel, Steinkreis, Meeresgrotte), Materialorte mit eingefärbtem Boden und Ausstattung; **Urstein-Adern** mit Stollen, Schienen und leuchtenden Adern (Gu-Yue-Klan, Shang-Mine, Drachenader der Wu, dazu freie Adern in den Graslanden und am Sektenberg): Klanmitglieder verdienen beim Abbau Verdienst, Fremde stehlen und werden berüchtigt, verkleidet bleibt es unbemerkt; **Dao-Orte** in jedem Gebiet (Mondschrein der Gu Yue, Schwerthügel, Dang-Hun-Berg, Drachenwirbel, Hügel der Riesenkraft, Sonnenuhr im Sand, Muschelhorn der Gezeiten, Stein der Einsicht, Blutaltar, Altar des ewigen Eises, Glutherz der Schlucht, Donnerklippe, Windklippe der Kraniche): Steinkreis mit leuchtenden Runen, wer dort kultiviert, sammelt Dao-Markierungen in diesem Pfad. Bestienfluten (Wolfsflut am Qing-Mao-Berg und in den Graslanden, Echsenflut am Drachenfluss, Flut der Tiefe auf den Inseln) mit Lohn und Sektenverdienst; Sektenleben (Beitritt, sechs Ränge, Zuteilung, Signatur-Gu). Wetter je Biom (Regen in Dschungel und Sümpfen, Schnee am Yi-Tian-Berg, Sandstürme in Wüste und Schlucht); nachts leuchten Fenster und Laternen der Siedlungen; Gu-Lexikon mit allen 232 Gu (bekannt durch Besitz, Sichtung oder Kampf); Klanfehden (Bai-Klan gegen Gu Yue, Schattensekte gegen die Zehn Extreme). Minikarte (mit Gebiet und Region) und gemalte Weltkarte mit Küsten, Flüssen, Inseln und Reisen; Gebirgskranz bis zum Horizont, Biome mit eigenen Pflanzen, Farben und Meer. **35 Gu-Familien mit je 5 Rängen (175 aktive Gu)**, darunter Positionstausch, Plünderhand (Essenzraub), Hartes Qi, Irrgarten-Formation, Zeitblase, Gedankenblitz, Glücksstern, Bestiengestalt und Glockenklang, mit eigenen Wirkformen, Ranggaben und einer Partikel-Handschrift je Pfad (Glut, Eisscherben, Blitzäste, Giftblasen, Blätter, Irrlichter …), 23 Körper- und 34 Hilfs-Gu (u. a. Menschenhaut zur Verkleidung, Kaktuszeiger, Panzer, Krokodilkraft), 10 Zustände, 16 Reaktionen, **134 Killer Moves** aus 105 Gu-Paaren in drei Stufen; Bestien Rang 1–5 mit eigenen Fähigkeiten und Bestienkönige als Erbschafts-Wächter; Gu-Meister Rang 2–5 in allen Siedlungen (Duelle mit rangabhängigem Lohn, angekündigte Killer Moves; im Gu-Yue-Dorf eine Rangleiter: Klanlehrer, Vorsteher der Chi- und Mo-Familie, Klanführer); Relikt-Gu zum Verfeinern; 20 Verschmelzungs-Rezepte (Weißjade, Schnapswurm-Reihe, Jun-Kraft, Menschenhaut, Blutschädel, Mondsichel …); Händler mit regionalen Materialien und Auktionen für Rang-3- bis Rang-5-Gu. **Rechtschaffener und dämonischer Pfad:** wandernde Gu-Meister auf Straßen und in der Wildnis (Streuner, Wegelagerer, Sandräuber, Seeräuber, Blutflügel- und Schattenälteste überfallen dich, Klan-Patrouillen ziehen vorbei); Besiegte ergeben sich – töten (Geldbeutel, ihre Gu wild), ausrauben oder verschonen; Ruf mit Ansehen und Berüchtigtheit (Gesucht: Kopfgeldjäger, Aufschlag, Klans lehnen ab; Dämon: kein Handel und kein Duell bei Rechtschaffenen; dämonische Sekten nehmen nur Berüchtigte). Balancing mit `tools/balance_probe.gd` gemessen (Bestien, Familien, Duelle; Rückstoß mit abnehmender Wirkung und Masse-Widerstand, Kontrolle, Killer Moves gedeckelt; Meister je Rang gedämpft) und Tempo mit `tools/pacing_probe.gd` (Aperturwand verlangt je Rang doppelt so viel Essenz, damit Rang 5 nicht in einer Stunde fällt); jedes Aufstiegsmaterial ist bis zum Zielrang zu finden (Import prüft). Offen: Playtest am Handy, Kalamitäten (M5).
...
**M3 – Tiefe:** Ränge 3–5 (umgesetzt: alle Familien bis Rang 5, dreiundzwanzig neue Familien, 134 Killer Moves); umgesetzt: Sektenleben mit Rängen und Zuteilung, Dao-Beherrschung; umgesetzt: tägliche Sektenaufträge, Herkunft im Klan als Startoption
...
- Kindheit länger machen: Kampfübung mit Holzschwert gegen eine Ratte, erster Blick auf wilde Gu (umgesetzt: Gespräch mit Onkel und Tante, die das Erbe der Eltern verwalten).
