...
- **Gu-Effekte:** leuchtend und gesättigt vor der gedämpften Welt. Jeder Pfad hat seine Farbe (`PATH_COLOR` in `docs/daten/gu.json`), damit man Fähigkeiten auf einen Blick erkennt. Partikel sparsam, lieber wenige große als viele kleine.
